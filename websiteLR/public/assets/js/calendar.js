...
const getKeyByValue = (arr, value) => Object.keys(arr).find(key => arr[key] === value);
...
function makeTableDate(choosedMonth) {
    ...
    let wasCalled = false;
    if (1 < choosedMonth.getDay()) choosedMonth = new Date(choosedMonth.getFullYear(), choosedMonth.getMonth(), 1 - choosedMonth.getDay() + 1);
